...
$notifications = getNotifications($pdo, $user_id, 20);
$avatar = getUserAvatarSource($pdo, (int) $user_id, "../public/assets/images/default.png");
    ...
    <div class="topbar-right">
        <div class="quick-actions-wrapper">
            ...
            <div class="quick-actions-dropdown" id="quickActionsDropdown">
                ...
                <a href="incidents.php?status=Submitted"><i class="fa-solid fa-triangle-exclamation"></i><span>Review Incidents</span></a>
            ...
            <div class="notification-dropdown" id="notifDropdown" data-notification-dropdown>
                ...
                <?php if (empty($notifications)): ?>
                    <div class="notification-empty-state">
                        ...
                        <p>Request updates, release alerts, and reminders will appear here.</p>
                    </div>
                <?php else: ?>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let unreadCount = <?php echo (int) $unreadCount; ?>;
        ...
        markAllButton.addEventListener("click", function (event) {
            ...
            fetch("../includes/mark_read.php", {
                ...
                .then(function (response) {
                    ...
                    notifWrapper.querySelectorAll(".notif-item.unread").forEach(function (item) {
                        item.classList.remove("unread");
                        item.dataset.notificationUnread = "0";
                        const pill = item.querySelector(".notif-pill");
                        if (pill) pill.remove();
                    });
                    unreadCount = 0;
                    updateUnreadUi();
