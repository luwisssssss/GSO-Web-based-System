...
require_once dirname(__DIR__, 3) . "/includes/avatar_helper.php";
...
if (!$user) {
    redirectWithFlash("browse.php", "Borrower profile not found.");
}
...
/* ================= PROFILE IMAGE ================= */
$profileImage = buildAvatarSource($user, "../public/assets/images/default.png");
...
$activeLoans = $stmtActive->fetchColumn();
?>
...
<head>
    ...
    <link rel="stylesheet" href="../public/assets/css/pages/borrower.css">
    <link rel="stylesheet" href="../public/assets/css/pages/profile.css">
...
<?php include(dirname(__DIR__, 3) . "/includes/borrower_topbar.php"); ?>
<?php include(dirname(__DIR__, 3) . "/includes/borrower_sidebar.php"); ?>
    ...
    <div class="profile-body">
        ...
        <div class="right">
            ...
            <div class="verified-img">
                <img src="../public/assets/images/verified.png" alt="Verified">
            </div>
...
<script src="../public/assets/js/ui-redesign.js?v=20260415-sidebar-motion" defer></script>
</body>
</html>
