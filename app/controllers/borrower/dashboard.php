        ...
        <section class="dashboard-chart-grid">
            <div class="dashboard-chart-panel chart-main">
                ...
                <div class="donut-row">
                    ...
                    <div class="chart-legend">
                        ...
                        <span><i class="legend-color-released"></i> Borrowed: <?php echo (int) ($requestPipeline["released_count"] ?? 0); ?></span>
                        <span><i class="legend-color-returned"></i> Returned: <?php echo (int) ($requestPipeline["returned_count"] ?? 0); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="dashboard-chart-panel">
                ...
                <div class="compact-legend">
                    <span><i class="legend-color-active"></i> Active <?php echo (int) ($loanState["active_count"] ?? 0); ?></span>
                    <span><i class="legend-color-due-soon"></i> Due Soon <?php echo (int) ($loanState["due_soon_count"] ?? 0); ?></span>
                    <span><i class="legend-color-danger"></i> Overdue <?php echo (int) ($loanState["overdue_count"] ?? 0); ?></span>
                    <span><i class="legend-color-return-pending"></i> Return Pending <?php echo (int) ($loanState["return_pending_count"] ?? 0); ?></span>
                </div>
            </div>
