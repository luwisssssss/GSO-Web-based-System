...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!hash_equals((string) $_SESSION["csrf_token"], $csrfToken)) {
        ...
        if (!$user) {
            ...
            $message = ($user["role"] ?? "") === "Borrower"
                ? "Your borrower account is still pending admin approval."
                : "Your administrator account is still pending approval.";
            $messageType = "warning";
            ...
            $_SESSION["auth_started_at"] = $authenticatedAt;
            $_SESSION["last_activity_at"] = $authenticatedAt;
...
<head>
    ...
    <link rel="stylesheet" href="../public/assets/css/pages/login.css?v=20260419-login-guard">
