<?php
require_once dirname(__DIR__, 3) . "/includes/role_helper.php";
...
<link rel="stylesheet" href="../public/assets/css/pages/landing.css?v=20260419-formal-landing">
<link rel="stylesheet" href="../public/assets/css/pages/footer.css?v=20260419-formal-footer">
...
<header class="navbar" id="navbar">
    <div class="container nav">
        ...
        <a class="logo" href="#home" aria-label="General Services Office  home">
            <span class="logo-frame"><img src="../public/assets/images/logo.png" alt="GSO logo"></span>
...
<section class="hero" id="home">
    ...
    <video autoplay muted loop playsinline class="bg-video" aria-hidden="true">
        <source src="../public/assets/images/video_bg.mp4" type="video/mp4">
    </video>
    ...
    <div class="container about-content">
        ...
        <div class="about-brand-stack">
            <div class="about-logo-wrap">
                <img src="../public/assets/images/login_logo.png" class="about-logo" alt="GSO system brand mark">
            </div>
...
<section class="key-features" id="features">
    ...
    <div class="container key-grid">
        ...
        <div class="profile-side">
            <img src="../public/assets/images/admin_profile.jpg" class="profile-img" alt="General Services Office representative">
